                    ...
                    <div class="row">
                        <div class="col-sm-4 border-right">
                            <div class="description-block">
                                ...
                                <span class="description-text"><a href="{{ route('admin_ofertas') }}">OFERTAS</a></span>
                            </div><!-- /.description-block -->
                        </div><!-- /.col -->
                        <div class="col-sm-4 border-right">
                            <div class="description-block">
                                <h5 class="description-header">{{ $empresas }}</h5>
                                <span class="description-text"><a href="{{ route('admin_empresas') }}">EMPRESAS</a></span>
                            </div><!-- /.description-block -->
                        </div><!-- /.col -->
                        <div class="col-sm-4">
                            <div class="description-block">
                                <h5 class="description-header">{{ $estudiantes }}</h5>
                                <span class="description-text"><a href="{{ route('admin_estudiantes') }}">ESTUDIANTES</a></span>
                            </div><!-- /.description-block -->
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div>
