            ...
            <div class="box-body">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <input type="text" name="nombre" style="width:100%" placeholder="Nombre del Contacto" value="{{ old('nombre', $usuario->nombre_usuario) }}" class="{{ $errors->has('nombre') ? 'error' : '' }}">
                        ...
                        <div class="form-group">
                            <input type="text" name="email" style="width:100%" placeholder="Correo Institucional" value="{{ old('email', $usuario->email_usuario) }}" class="{{ $errors->has('email') ? 'error' : '' }}">
